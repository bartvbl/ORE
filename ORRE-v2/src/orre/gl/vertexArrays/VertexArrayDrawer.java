...
public class VertexArrayDrawer {
	...
	public static void drawTriangles(float[] vertices, int[] indices, int axisCount, int vertexCount) {
	...
	public static void drawQuads(float[] vertices, int axisCount) {
		draw(GL_QUADS, vertices.length / 4, vertices, axisCount);
	}
	
	private static void draw(int glEnum, int vertexCount, float[] vertices, int axisCount) {
		vertexBuffer.rewind();
